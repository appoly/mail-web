        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-3/4 h-screen" v-if="selectedEmail !== null">
                ...
                <div class="card w-full mx-5 mb-3">
                    ...
                    <button :class="[{'text-gray-300':view === 'html'},'btn']" @click="view = 'html'">HTML Source</button>
                    <button :class="[{'text-gray-300':view === 'markdown'},'btn']" @click="view = 'markdown'">Markdown</button>
                </div>
                <!-- </div> -->
                <div class="card h-full mx-5 flex justify-center bg-gray-200">
                    <iframe v-if="view === 'xl' || view === 'md' || view === 'sm' " :class="[widthClass, 'h-screen']" :srcdoc="selectedEmail.body" frameborder="0"></iframe>
